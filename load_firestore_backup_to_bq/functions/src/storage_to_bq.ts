...
const LoadFirestoreBackup = functions.storage.bucket(triggerBucket).object().onFinalize((objectMetadata) => {
    ...
    return Promise.resolve("success to request storageToBq")
});

export { LoadFirestoreBackup }
